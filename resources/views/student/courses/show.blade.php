                        ...
                        <div style="background:white; border:1px solid #e2e8f0; border-radius:12px; padding:24px; margin-bottom:16px; display:flex; justify-content:space-between; align-items:center; transition: transform 0.2s, box-shadow 0.2s;" 
                            ...
                            <div style="flex:1;">
                                <div style="display:flex; align-items:center; gap:10px; margin-bottom:8px;">
                                    <span style="font-size:11px; font-weight:700; background:#f5f3ff; color:#6366f1; padding:2px 8px; border-radius:4px; border:1px solid #e0e7ff;">{{ $module->title }}</span>
                                    <h4 style="font-size:18px; font-weight:700; color:#1e293b; margin:0;">
                                        {{ $assignment->title }}
                                    </h4>
                                </div>
                                <p style="font-size:14px; color:#64748b; margin:0 0 12px 0; max-width:85%; line-height:1.5;">
                                    {{ $assignment->instructions ?? 'Silakan baca instruksi lengkap pada lampiran atau detail tugas.' }}
                                </p>
