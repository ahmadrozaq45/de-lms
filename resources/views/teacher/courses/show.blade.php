                ...
                <div class="p-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <form action="{{ route('teacher.modules.update', $module->id) }}" method="POST">
                            ...
                            <button type="submit" class="bg-yellow-50 text-yellow-600 hover:bg-yellow-100 p-2 rounded-lg transition" title="Edit Modul">
                        ...
                        @forelse($module->materials as $material)
                            <div class="flex items-center justify-between p-3 bg-gray-50/50 rounded-xl hover:bg-gray-50 transition-all border border-gray-100 group">
                                ...
                                <form action="{{ route('teacher.materials.update', $material->id) }}" method="POST">
                                    ...
                                    <button type="submit" class="text-gray-400 hover:text-yellow-600 p-2 rounded-lg hover:bg-yellow-50 transition" title="Edit Materi">
